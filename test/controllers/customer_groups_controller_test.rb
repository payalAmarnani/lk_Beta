...
class CustomerGroupsControllerTest < ActionController::TestCase
  ...
  test "should create customer_group" do
    assert_difference('CustomerGroup.count') do
      post :create, customer_group: { active: @customer_group.active, group_type: @customer_group.group_type, hidden: @customer_group.hidden, name: @customer_group.name }
    end
  ...
  test "should update customer_group" do
    patch :update, id: @customer_group, customer_group: { active: @customer_group.active, group_type: @customer_group.group_type, hidden: @customer_group.hidden, name: @customer_group.name }
    assert_redirected_to customer_group_path(assigns(:customer_group))
  end
